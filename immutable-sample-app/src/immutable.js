...
const passportConfig = {
  clientId: import.meta.env.VITE_IMMUTABLE_CLIENT_ID ?? "KmtnvFVBIymAOa5gqqljYkjYQkCCAyTB",
  redirectUri: `${import.meta.env.VITE_BASE_URL ?? "https://super-duper-space-potato-jv74g77xg44cp4q7-5003.app.github.dev"}/callback`,
  logoutRedirectUri: import.meta.env.VITE_BASE_URL ?? "https://super-duper-space-potato-jv74g77xg44cp4q7-5003.app.github.dev/",
